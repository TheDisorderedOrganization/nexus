        ...
        for connectivity in connectivities:
            ...
            if percolating_clusters:
                ...
                if len(percolation_probabilities) == 1:
                    self.percolation_probabilities[connectivity].append([1, 0, 0])
                elif len(percolation_probabilities) == 2:
                    self.percolation_probabilities[connectivity].append([1, 1, 0])
                elif len(percolation_probabilities) == 3:
                    self.percolation_probabilities[connectivity].append([1, 1, 1])
                else:
                    self.percolation_probabilities[connectivity].append([0, 0, 0])
