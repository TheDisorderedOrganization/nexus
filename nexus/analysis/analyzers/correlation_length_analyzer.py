...
class CorrelationLengthAnalyzer(BaseAnalyzer):
    ...
    def finalize(self) -> None:
        ...
        return {"concentrations": self.concentrations, "correlation_length": self.correlation_length, "std": self.std}
    ...
    def _write_header(self) -> None:
        ...
        if not overwrite and os.path.exists(path):
            with open(path, 'a', encoding='utf-8') as output:
                ...
                output.write("# Connectivity_type,Concentration,Correlation_length,Standard_deviation_ddof=1\n")
            output.close()
        else:
    ...
    def _write_data(self) -> None:
        ...
        with open(path, "a") as f:
            for connectivity in self.correlation_length:
                ...
                f.write(f"{connectivity},{concentration},{correlation_length},{std}\n")
